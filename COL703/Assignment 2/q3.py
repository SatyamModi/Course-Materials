...
def solve(formula_file, modified_proof_file, output_file):
    global blanks  # list to store blank results
    global p_clauses  # list to store proof clauses
    global f_clauses # list to store formula clauses
    global p_lines # list to store proof lines
    global f_lines# list to store formula lines
    global num_atoms
    global num_formulas 
    blanks = []  # list to store blank results
    p_clauses = []  # list to store proof clauses
    ...
    with open(modified_proof_file) as p:
        p_lines = p.readlines()
...
modified_proof_file = sys.argv[2]
output_file = sys.argv[3]
solve(formula_file, modified_proof_file, output_file)
