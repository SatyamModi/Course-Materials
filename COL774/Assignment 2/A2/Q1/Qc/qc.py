...
def random_pred():
    ...
    confusion_matrix_random = metrics.confusion_matrix(np.array(actual), np.array(random_prediction))
    cm_display_random = metrics.ConfusionMatrixDisplay(confusion_matrix = confusion_matrix_random, display_labels = [0, 1])
    cm_display_random.plot()
